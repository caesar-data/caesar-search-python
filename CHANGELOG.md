...
- Breaking: removed `usage.approx_tokens` from responses; `Usage` now has only `requests` and `bytes_returned`.
...
Releases are documented on the [GitHub releases page](https://github.com/caesar-data/caesar-search-python/releases).
